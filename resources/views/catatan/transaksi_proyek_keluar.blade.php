                ...
                <div class="float-right">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right checkbox-menu">
                            ...
                            <a class="dropdown-item active" id="keluar" style="font-size: 12px;" onclick="tes(this)">
                                Keluar
                            </a>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="editCommentModal" tabindex="-1" role="dialog" aria-labelledby="editCommentModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="edit-comment-transaksi" method="post" action="{{ route('insertComment',  ['place' => 4]) }}">
                        @csrf
...
<script>
    ...
    function tes(el){
        ...
        var type =$(el).attr('id');
        let url;
        type = type ? url = '/transaksi_proyek_with_type/' + type : url = "/transaksi_proyek";
