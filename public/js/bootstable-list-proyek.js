...
function rowEdit(but) { //Inicia la edición de una fila
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            //$('#daterange-edit').val(data['tgl_transaksi']);
            $('#edit-id').val(data['id']);
            $('#edit-kodeproyek').val(data['kode_proyek']);
            $('#edit-jenis-status').val(data['status']);
            $('#edit-nama-perusahaan').val(data['id_perusahaan']);
            $('#edit-nama-pemilik').val(data['id_pemilik']);
            $('#edit-jenisproyek').val(data['jenis']);
